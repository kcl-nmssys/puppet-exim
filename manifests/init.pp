class exim (
  ...
  Optional[String] $tls_certificate_content  = '',
  String $tls_privatekey_path,
  Optional[String] $tls_privatekey_content   = '',
  ...
  Optional[String] $ldap_hostname            = '',
  Optional[String] $ldap_base_dn             = '',
  Optional[String] $ldap_bind_dn             = '',
  Optional[String] $ldap_passwd              = '',
